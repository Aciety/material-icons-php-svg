...
final class Groups2SharpIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I1);
        $l2I2 = new SVGPath(d: 'M16.24,13.65c-1.17-0.52-2.61-0.9-4.24-0.9c-1.63,0-3.07,0.39-4.24,0.9C6.68,14.13,6,15.21,6,16.39V18h12v-1.61 C18,15.21,17.32,14.13,16.24,13.65z');
        $l1I0->addChild($l2I2);
