...
final class Groups3TwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I0);
        $l2I1 = new SVGCircle(cx: '12', cy: '9', r: '1');
        ...
        $l1I0->addChild($l2I4);
        $l2I5 = new SVGPath(d: 'M12,12c1.66,0,3-1.34,3-3c0-1.66-1.34-3-3-3S9,7.34,9,9C9,10.66,10.34,12,12,12z M12,8c0.55,0,1,0.45,1,1s-0.45,1-1,1 s-1-0.45-1-1S11.45,8,12,8z');
        $l1I0->addChild($l2I5);
        $l2I6 = new SVGRect(x: '2.23', y: '9.23', width: '3.54', height: '3.54');
        $l2I6->setAttribute('transform', 'matrix(0.7071 -0.7071 0.7071 0.7071 -6.6066 6.0503)');
        $l1I0->addChild($l2I6);
        $l2I7 = new SVGPolygon(points: [[20, 9], [17.5, 13], [22.5, 13]]);
        $l1I0->addChild($l2I7);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
