...
final class PeopleAltSharpIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I1 = new SVGGroup();
        $l2I0 = new SVGGroup();
        $l3I0 = new SVGPath(d: 'M16.67,13.13C18.04,14.06,19,15.32,19,17v3h4v-3 C23,14.82,19.43,13.53,16.67,13.13z');
        ...
        $l1I1->addChild($l2I2);
        $l2I3 = new SVGGroup();
        $l3I0 = new SVGPath(d: 'M9,13c-2.67,0-8,1.34-8,4v3h16v-3C17,14.34,11.67,13,9,13z');
        $l3I0->setStyle('fill-rule', 'evenodd');
        $l2I3->addChild($l3I0);
        $l1I1->addChild($l2I3);
        $l0I1->addChild($l1I1);
