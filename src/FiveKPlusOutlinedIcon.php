...
final class FiveKPlusOutlinedIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l2I0->addChild($l3I0);
        $l3I1 = new SVGPath(d: 'M10,14v-1.5c0-0.55-0.45-1-1-1H7.5v-1H10V9H6v3.5h2.5v1H6V15h3C9.55,15,10,14.55,10,14z');
        $l2I0->addChild($l3I1);
