...
final class SportsGolfRoundedIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I3);
        $l2I4 = new SVGPath(d: 'M16,17H8c-0.55,0-1,0.45-1,1c0,0.55,0.45,1,1,1h1c1.1,0,2,0.9,2,2v1h2v-1c0-1.1,0.9-2,2-2h1c0.55,0,1-0.45,1-1 C17,17.45,16.55,17,16,17z');
        $l1I0->addChild($l2I4);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
