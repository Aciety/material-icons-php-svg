...
final class SettingsPhoneRoundedIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l0I1 = new SVGGroup();
        $l1I0 = new SVGGroup();
        $l2I0 = new SVGCircle(cx: '12', cy: '10', r: '1');
        $l1I0->addChild($l2I0);
        $l2I1 = new SVGCircle(cx: '16', cy: '10', r: '1');
        $l1I0->addChild($l2I1);
        $l2I2 = new SVGCircle(cx: '20', cy: '10', r: '1');
        $l1I0->addChild($l2I2);
