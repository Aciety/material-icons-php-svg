...
final class LunchDiningSharpIcon extends SVG
{
    public function __construct()
    {
        ...
        $l0I1 = new SVGGroup();
        $l1I0 = new SVGGroup();
        $l2I0 = new SVGRect(x: '2', y: '16', width: '20', height: '5');
        $l1I0->addChild($l2I0);
        ...
        $l1I0->addChild($l2I1);
        $l2I2 = new SVGPath(d: 'M22,9c0.02-4-4.28-6-10-6C6.29,3,2,5,2,9v1h20L22,9L22,9z');
        $l1I0->addChild($l2I2);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
