...
final class ElevenMpTwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l0I1 = new SVGGroup();
        $l1I0 = new SVGGroup();
        $l2I0 = new SVGPath(d: 'M5,19h14V5H5V19z M18,13.5V16c0,0.55-0.45,1-1,1h-2v1.5h-1.5v-6H17C17.55,12.5,18,12.95,18,13.5z M13,5.5h3 v6h-1.5V7H13V5.5z M8,5.5h3v6H9.5V7H8V5.5z M6,13.5c0-0.55,0.45-1,1-1h4.5c0.55,0,1,0.45,1,1v5H11V14h-1v3H8.5v-3h-1v4.5H6V13.5z');
        ...
        $l1I0->addChild($l2I4);
        $l2I5 = new SVGGroup();
        $l3I0 = new SVGPolygon(points: [[9.5, 11.5], [11, 11.5], [11, 5.5], [8, 5.5], [8, 7], [9.5, 7]]);
        $l2I5->addChild($l3I0);
        $l1I0->addChild($l2I5);
        $l2I6 = new SVGGroup();
        $l3I0 = new SVGPolygon(points: [[14.5, 11.5], [16, 11.5], [16, 5.5], [13, 5.5], [13, 7], [14.5, 7]]);
        $l2I6->addChild($l3I0);
        $l1I0->addChild($l2I6);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
