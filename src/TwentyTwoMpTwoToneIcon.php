...
final class TwentyTwoMpTwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I5);
        $l2I6 = new SVGPath(d: 'M17.5,10h-3V9h2c0.55,0,1-0.45,1-1V6.5c0-0.55-0.45-1-1-1H13V7h3v1h-2c-0.55,0-1,0.45-1,1v2.5h4.5V10z');
        $l1I0->addChild($l2I6);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
