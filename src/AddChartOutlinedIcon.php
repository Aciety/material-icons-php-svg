...
final class AddChartOutlinedIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l0I1 = new SVGGroup();
        $l1I0 = new SVGGroup();
        $l2I0 = new SVGPath(d: 'M19,19H5V5h9V3H5C3.9,3,3,3.9,3,5v14c0,1.1,0.9,2,2,2h14c1.1,0,2-0.9,2-2v-9h-2V19z');
        $l1I0->addChild($l2I0);
        $l2I1 = new SVGRect(x: '15', y: '13', width: '2', height: '4');
        $l1I0->addChild($l2I1);
        $l2I2 = new SVGRect(x: '7', y: '10', width: '2', height: '7');
        $l1I0->addChild($l2I2);
        $l2I3 = new SVGRect(x: '11', y: '7', width: '2', height: '10');
        $l1I0->addChild($l2I3);
