...
final class Face6TwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l0I1 = new SVGGroup();
        $l1I0 = new SVGGroup();
        $l2I0 = new SVGPath(d: 'M6.55,7.66C7.06,6.64,8.09,6,9.24,6h5.53c1.14,0,2.17,0.64,2.68,1.66c0.94,1.87,1.66,2.08,2.26,2.24 C18.78,6.51,15.68,4,12,4S5.22,6.51,4.29,9.9C4.97,9.72,5.62,9.52,6.55,7.66z');
        ...
        $l1I0->addChild($l2I2);
        $l2I3 = new SVGCircle(cx: '15', cy: '13', r: '1.25');
        $l1I0->addChild($l2I3);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
