...
final class FifteenMpOutlinedIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I3);
        $l2I4 = new SVGPath(d: 'M16.5,10.5V9c0-0.55-0.45-1-1-1h-2V7h3V5.5H12V9h3v1h-3v1.5h3.5C16.05,11.5,16.5,11.05,16.5,10.5z');
        $l1I0->addChild($l2I4);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
