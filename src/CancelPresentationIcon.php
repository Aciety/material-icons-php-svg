...
final class CancelPresentationIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $doc->addChild($l0I2);
        $l0I3 = new SVGPath(d: 'M14.59 8L12 10.59 9.41 8 8 9.41 10.59 12 8 14.59 9.41 16 12 13.41 14.59 16 16 14.59 13.41 12 16 9.41z');
        $doc->addChild($l0I3);
    }
}
