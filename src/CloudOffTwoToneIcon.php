...
final class CloudOffTwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $doc->addChild($l0I0);
        $l0I1 = new SVGPath(d: 'M22 15c0-1.66-1.34-3-3-3h-1.5v-.5C17.5 8.46 15.04 6 12 6c-.77 0-1.49.17-2.16.46L20.79 17.4c.73-.55 1.21-1.41 1.21-2.4zM2 14c0 2.21 1.79 4 4 4h9.73l-8-8H6c-2.21 0-4 1.79-4 4z');
