...
final class FaceTwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $doc->addChild($l0I0);
        $l0I1 = new SVGPath(d: 'M17.5 8c.46 0 .91-.05 1.34-.12C17.44 5.56 14.9 4 12 4c-.46 0-.91.05-1.34.12C12.06 6.44 14.6 8 17.5 8zM8.08 5.03C6.37 6 5.05 7.58 4.42 9.47c1.71-.97 3.03-2.55 3.66-4.44z');
        ...
        $doc->addChild($l0I2);
        $l0I3 = new SVGCircle(cx: '9', cy: '13', r: '1.25');
        $doc->addChild($l0I3);
        $l0I4 = new SVGCircle(cx: '15', cy: '13', r: '1.25');
        $doc->addChild($l0I4);
    }
}
