...
final class UpcomingIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I2);
        $l2I3 = new SVGPath(d: 'M20,12h-5c0,1.66-1.34,3-3,3s-3-1.34-3-3H4c-1.1,0-2,0.9-2,2v5c0,1.1,0.9,2,2,2h16c1.1,0,2-0.9,2-2v-5 C22,12.9,21.1,12,20,12z');
        $l1I0->addChild($l2I3);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
