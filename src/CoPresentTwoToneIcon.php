...
final class CoPresentTwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0 = new SVGGroup();
        $l2I0 = new SVGGroup();
        $l3I0 = new SVGCircle(cx: '9', cy: '10', r: '2');
        $l2I0->addChild($l3I0);
        $l2I0->setStyle('opacity', '.3');
        $l1I0->addChild($l2I0);
        $l2I1 = new SVGGroup();
        $l3I0 = new SVGPath(d: 'M14.48,18.34C13.29,17.73,11.37,17,9,17c-2.37,0-4.29,0.73-5.48,1.34C2.9,18.66,3,19.28,3,20h12 C15,19.29,15.11,18.66,14.48,18.34z');
        $l2I1->addChild($l3I0);
