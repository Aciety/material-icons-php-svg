...
final class ThirteenMpOutlinedIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l0I1 = new SVGGroup();
        $l1I0 = new SVGGroup();
        $l2I0 = new SVGPolygon(points: [[8.5, 11.5], [10, 11.5], [10, 5.5], [7, 5.5], [7, 7], [8.5, 7]]);
        $l1I0->addChild($l2I0);
        $l2I1 = new SVGPath(d: 'M16.5,10.5v-4c0-0.55-0.45-1-1-1H12V7h3v1h-2v1h2v1h-3v1.5h3.5C16.05,11.5,16.5,11.05,16.5,10.5z');
        $l1I0->addChild($l2I1);
