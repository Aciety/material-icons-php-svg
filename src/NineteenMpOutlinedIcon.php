...
final class NineteenMpOutlinedIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I3);
        $l2I4 = new SVGPath(d: 'M16.5,10.5v-4c0-0.55-0.45-1-1-1H13c-0.55,0-1,0.45-1,1V8c0,0.55,0.45,1,1,1h2v1h-3v1.5h3.5 C16.05,11.5,16.5,11.05,16.5,10.5z M15,8h-1.5V6.5H15V8z');
        $l1I0->addChild($l2I4);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
