...
final class Person2TwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l0I1 = new SVGGroup();
        $l1I0 = new SVGGroup();
        $l2I0 = new SVGPath(d: 'M13.9,7.59C13.74,6.67,12.94,6,12,6s-1.74,0.67-1.9,1.59L9.78,10h4.44L13.9,7.59z');
        ...
        $l1I0->addChild($l2I2);
        $l2I3 = new SVGPath(d: 'M9.78,12h4.44c1.21,0,2.14-1.06,1.98-2.26l-0.32-2.45C15.57,5.39,13.92,4,12,4S8.43,5.39,8.12,7.29L7.8,9.74 C7.64,10.94,8.57,12,9.78,12z M10.1,7.59C10.26,6.67,11.06,6,12,6s1.74,0.67,1.9,1.59L14.22,10H9.78L10.1,7.59z');
        $l1I0->addChild($l2I3);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
