...
final class AppBlockingRoundedIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I1->addChild($l2I0);
        $l2I1 = new SVGPath(d: 'M17,18H7V6h10v1h2V6V5V3c0-1.1-0.9-2-2-2H7C5.9,1,5,1.9,5,3v18c0,1.1,0.9,2,2,2h10c1.1,0,2-0.9,2-2v-2v-1v-1h-2V18z');
        $l1I1->addChild($l2I1);
        $l0I0->addChild($l1I1);
        $doc->addChild($l0I0);
    }
