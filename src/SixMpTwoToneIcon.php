...
final class SixMpTwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I0);
        $l2I1 = new SVGRect(x: '11.5', y: '9', width: '1.5', height: '1.5');
        ...
        $l1I0->addChild($l2I5);
        $l2I6 = new SVGPath(d: 'M11,11.5h2.5c0.55,0,1-0.45,1-1V9c0-0.55-0.45-1-1-1h-2V7h3V5.5H11c-0.55,0-1,0.45-1,1v4C10,11.05,10.45,11.5,11,11.5z M11.5,9H13v1.5h-1.5V9z');
        $l1I0->addChild($l2I6);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
