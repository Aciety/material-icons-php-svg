...
final class MapsUgcTwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $doc->addChild($l0I0);
        $l0I1 = new SVGPath(d: 'M12,4c4.41,0,8,3.59,8,8s-3.59,8-8,8c-1.18,0-2.34-0.26-3.43-0.78c-0.27-0.13-0.56-0.19-0.86-0.19 c-0.19,0-0.38,0.03-0.56,0.08l-3.2,0.94l0.94-3.2c0.14-0.47,0.1-0.98-0.11-1.42C4.26,14.34,4,13.18,4,12C4,7.59,7.59,4,12,4');
        ...
        $l0I2->addChild($l1I0);
        $doc->addChild($l0I2);
        $l0I3 = new SVGPolygon(points: [[13, 8], [11, 8], [11, 11], [8, 11], [8, 13], [11, 13], [11, 16], [13, 16], [13, 13], [16, 13], [16, 11], [13, 11]]);
        $l0I3->setStyle('fill-rule', 'evenodd');
        $doc->addChild($l0I3);
    }
}
