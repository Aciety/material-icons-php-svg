...
final class Diversity1SharpIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I3);
        $l2I4 = new SVGPath(d: 'M16.24,16.65c-1.17-0.52-2.61-0.9-4.24-0.9c-1.63,0-3.07,0.39-4.24,0.9C6.68,17.13,6,18.21,6,19.39V21h12v-1.61 C18,18.21,17.32,17.13,16.24,16.65z');
        $l1I0->addChild($l2I4);
