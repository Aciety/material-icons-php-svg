...
final class SavingsTwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $doc->addChild($l0I0);
        $l0I1 = new SVGGroup();
        $l1I0 = new SVGPath(d: 'M19,9.5L15.5,6c0-0.65,0.09-1.29,0.26-1.91C14.79,4.34,14,5.06,13.67,6L7.5,6C5.57,6,4,7.57,4,9.5 c0,1.88,1.22,6.65,2.01,9.5L8,19v-2h6v2l2.01,0l1.55-5.15L20,13.03V9.5H19z M13,9H8V7h5V9z M16,11c-0.55,0-1-0.45-1-1 c0-0.55,0.45-1,1-1s1,0.45,1,1C17,10.55,16.55,11,16,11z');
        $l0I1->addChild($l1I0);
