...
final class IntegrationInstructionsTwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l0I0->addChild($l1I2);
        $l1I3 = new SVGLine(x1: '19', y1: '5', x2: '5', y2: '5');
        $l1I3->setStyle('fill', 'none');
        $l0I0->addChild($l1I3);
        $l1I4 = new SVGLine(x1: '5', y1: '19', x2: '19', y2: '19');
        $l1I4->setStyle('fill', 'none');
        $l0I0->addChild($l1I4);
        $l1I5 = new SVGGroup();
        ...
        $l0I0->addChild($l1I5);
        $doc->addChild($l0I0);
        $l0I1 = new SVGLine(x1: '19', y1: '5', x2: '5', y2: '5');
        $l0I1->setStyle('fill', 'none');
        $l0I1->setStyle('opacity', '.3');
        $doc->addChild($l0I1);
        $l0I2 = new SVGLine(x1: '5', y1: '19', x2: '19', y2: '19');
        $l0I2->setStyle('fill', 'none');
        $l0I2->setStyle('opacity', '.3');
        $doc->addChild($l0I2);
        $l0I3 = new SVGRect(x: '5', y: '5', width: '14', height: '14');
