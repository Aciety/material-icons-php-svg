...
final class BroadcastOnHomeSharpIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l0I1 = new SVGGroup();
        $l1I0 = new SVGGroup();
        $l2I0 = new SVGPath(d: 'M22,9.76V4H4v2h16v2.59C20.73,8.88,21.4,9.28,22,9.76z');
        $l1I0->addChild($l2I0);
        $l2I1 = new SVGPath(d: 'M9,9H2v11h7V9z M7,18H4v-7h3V18z');
        $l1I0->addChild($l2I1);
