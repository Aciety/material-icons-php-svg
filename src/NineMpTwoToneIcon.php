...
final class NineMpTwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I5);
        $l2I6 = new SVGPath(d: 'M14.5,10.5v-4c0-0.55-0.45-1-1-1H11c-0.55,0-1,0.45-1,1V8c0,0.55,0.45,1,1,1h2v1h-3v1.5h3.5 C14.05,11.5,14.5,11.05,14.5,10.5z M13,8h-1.5V6.5H13V8z');
        $l1I0->addChild($l2I6);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
