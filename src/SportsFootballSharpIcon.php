...
final class SportsFootballSharpIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I0);
        $l2I1 = new SVGPath(d: 'M13.08,3.28C10.75,3.7,8.29,4.62,6.46,6.46s-2.76,4.29-3.18,6.62l7.63,7.63c2.34-0.41,4.79-1.34,6.62-3.18 s2.76-4.29,3.18-6.62L13.08,3.28z M9.9,15.5l-1.4-1.4l5.6-5.6l1.4,1.4L9.9,15.5z');
        $l1I0->addChild($l2I1);
