...
final class FireTruckOutlinedIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I0);
        $l2I1 = new SVGPath(d: 'M11,8.5h-1v-2h1V5H1v1.5h1v2H1V10h10V8.5z M8.5,8.5H6.75v-2H8.5V8.5z M3.5,6.5h1.75v2H3.5V6.5z');
        $l1I0->addChild($l2I1);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
