...
final class TwoKPlusOutlinedIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l2I0->addChild($l3I0);
        $l3I1 = new SVGPath(d: 'M10,13.5H7.5v-1H9c0.55,0,1-0.45,1-1V10c0-0.55-0.45-1-1-1H6v1.5h2.5v1H7c-0.55,0-1,0.45-1,1V15h4V13.5z');
        $l2I0->addChild($l3I1);
