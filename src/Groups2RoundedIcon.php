...
final class Groups2RoundedIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l0I1 = new SVGGroup();
        $l1I0 = new SVGGroup();
        $l2I0 = new SVGPath(d: 'M10.27,12h3.46c0.93,0,1.63-0.83,1.48-1.75l-0.3-1.79C14.67,7.04,13.44,6,12,6S9.33,7.04,9.09,8.47l-0.3,1.79 C8.64,11.17,9.34,12,10.27,12z');
        $l1I0->addChild($l2I0);
        ...
        $l1I0->addChild($l2I1);
        $l2I2 = new SVGPath(d: 'M16.24,13.65c-1.17-0.52-2.61-0.9-4.24-0.9c-1.63,0-3.07,0.39-4.24,0.9C6.68,14.13,6,15.21,6,16.39L6,17 c0,0.55,0.45,1,1,1h10c0.55,0,1-0.45,1-1l0-0.61C18,15.21,17.32,14.13,16.24,13.65z');
        $l1I0->addChild($l2I2);
        $l2I3 = new SVGPath(d: 'M1.22,14.58C0.48,14.9,0,15.62,0,16.43L0,17c0,0.55,0.45,1,1,1l3.5,0v-1.61c0-0.83,0.23-1.61,0.63-2.29 C4.76,14.04,4.39,14,4,14C3.01,14,2.07,14.21,1.22,14.58z');
        $l1I0->addChild($l2I3);
        $l2I4 = new SVGPath(d: 'M22.78,14.58C21.93,14.21,20.99,14,20,14c-0.39,0-0.76,0.04-1.13,0.1c0.4,0.68,0.63,1.46,0.63,2.29V18l3.5,0 c0.55,0,1-0.45,1-1l0-0.57C24,15.62,23.52,14.9,22.78,14.58z');
        $l1I0->addChild($l2I4);
