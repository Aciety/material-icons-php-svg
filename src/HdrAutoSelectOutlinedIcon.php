...
final class HdrAutoSelectOutlinedIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I2);
        $l2I3 = new SVGPath(d: 'M16.5,16H13v6h1.5v-2h1.1l0.9,2H18l-0.9-2.1c0.5-0.3,0.9-0.8,0.9-1.4v-1C18,16.7,17.3,16,16.5,16z M16.5,18.5h-2v-1h2 V18.5z');
        $l1I0->addChild($l2I3);
