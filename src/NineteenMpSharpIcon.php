...
final class NineteenMpSharpIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I1);
        $l2I2 = new SVGPath(d: 'M3,3v18h18V3H3z M12,10h3V9h-3V5.5h4.5v6H12V10z M7,5.5h3v6H8.5V7H7V5.5z M12.5,18.5H11V14h-1v3H8.5v-3h-1v4.5H6v-6h6.5 V18.5z M18,17h-3v1.5h-1.5v-6H18V17z');
        $l1I0->addChild($l2I2);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
