...
final class TempleBuddhistIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0 = new SVGGroup();
        $l2I0 = new SVGGroup();
        $l3I0 = new SVGPath(d: 'M21,9.02c0,1.09-0.89,1.98-1.98,1.98H4.98C3.89,11,3,10.11,3,9.02H1c0,1.86,1.28,3.4,3,3.84V22h6v-3c0-1.1,0.9-2,2-2 s2,0.9,2,2v3h6v-9.14c0.55-0.14,3-1.04,3-3.86L21,9.02z');
        $l2I0->addChild($l3I0);
        $l1I0->addChild($l2I0);
        $l2I1 = new SVGGroup();
