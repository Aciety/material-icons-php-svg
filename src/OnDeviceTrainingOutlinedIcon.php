...
final class OnDeviceTrainingOutlinedIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I1);
        $l2I2 = new SVGPath(d: 'M18,1.01L6,1C4.9,1,4,1.9,4,3v18c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2V3C20,1.9,19.1,1.01,18,1.01z M18,21H6v-1h12V21z M18,18H6V6h12V18z M18,4H6V3h12V4z');
        $l1I0->addChild($l2I2);
