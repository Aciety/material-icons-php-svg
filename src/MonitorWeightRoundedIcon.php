...
final class MonitorWeightRoundedIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I0);
        $l2I1 = new SVGCircle(cx: '10.5', cy: '9', r: '.5');
        $l1I0->addChild($l2I1);
        $l2I2 = new SVGCircle(cx: '13.5', cy: '9', r: '.5');
        $l1I0->addChild($l2I2);
        $l2I3 = new SVGCircle(cx: '12', cy: '9', r: '.5');
        $l1I0->addChild($l2I3);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
