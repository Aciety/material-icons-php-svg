...
final class FourMpTwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I0);
        $l2I1 = new SVGPath(d: 'M5,19h14V5H5V19z M18,13.5V16c0,0.55-0.45,1-1,1h-2v1.5h-1.5v-6H17C17.55,12.5,18,12.95,18,13.5z M9.5,5.5 H11v3h1.5v-3H14v3h1V10h-1v1.5h-1.5V10h-3V5.5z M6,13.5c0-0.55,0.45-1,1-1h4.5c0.55,0,1,0.45,1,1v5H11V14h-1v3H8.5v-3h-1v4.5H6 V13.5z');
        ...
        $l1I0->addChild($l2I4);
        $l2I5 = new SVGPolygon(points: [[12.5, 11.5], [14, 11.5], [14, 10], [15, 10], [15, 8.5], [14, 8.5], [14, 5.5], [12.5, 5.5], [12.5, 8.5], [11, 8.5], [11, 5.5], [9.5, 5.5], [9.5, 10], [12.5, 10]]);
        $l1I0->addChild($l2I5);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
