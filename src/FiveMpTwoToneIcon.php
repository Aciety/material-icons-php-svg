...
final class FiveMpTwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I0);
        $l2I1 = new SVGPath(d: 'M5,19h14V5H5V19z M18,13.5V16c0,0.55-0.45,1-1,1h-2v1.5h-1.5v-6H17C17.55,12.5,18,12.95,18,13.5z M10,10h3 V9h-3V5.5h4.5V7h-3v1h2c0.55,0,1,0.45,1,1v1.5c0,0.55-0.45,1-1,1H10V10z M6,13.5c0-0.55,0.45-1,1-1h4.5c0.55,0,1,0.45,1,1v5H11V14 h-1v3H8.5v-3h-1v4.5H6V13.5z');
        ...
        $l1I0->addChild($l2I4);
        $l2I5 = new SVGPath(d: 'M14.5,10.5V9c0-0.55-0.45-1-1-1h-2V7h3V5.5H10V9h3v1h-3v1.5h3.5C14.05,11.5,14.5,11.05,14.5,10.5z');
        $l1I0->addChild($l2I5);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
