...
final class SixteenMpTwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I5);
        $l2I6 = new SVGPath(d: 'M13,11.5h2.5c0.55,0,1-0.45,1-1V9c0-0.55-0.45-1-1-1h-2V7h3V5.5H13c-0.55,0-1,0.45-1,1v4C12,11.05,12.45,11.5,13,11.5z M13.5,9H15v1.5h-1.5V9z');
        $l1I0->addChild($l2I6);
