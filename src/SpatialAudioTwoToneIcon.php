...
final class SpatialAudioTwoToneIcon extends SvgIcon
{
    public function __construct()
    {
        ...
        $l1I0->addChild($l2I3);
        $l2I4 = new SVGPath(d: 'M16,1h-2c0,4.97,4.03,9,9,9V8C19.14,8,16,4.86,16,1z');
        $l1I0->addChild($l2I4);
        $l2I5 = new SVGPath(d: 'M20,1h-2c0,2.76,2.24,5,5,5V4C21.35,4,20,2.65,20,1z');
        $l1I0->addChild($l2I5);
        $l0I1->addChild($l1I0);
        $doc->addChild($l0I1);
    }
