...
final class IconDownloaderTest extends TestCase
{
    ...
    public function testDownload(): void
    {
        $expectedCalls = [
            ...
            ['GET', 'https://fonts.gstatic.com/s/i/materialicons/1k/v10/24px.svg', __DIR__.'/../Fixtures/1k_24px.svg', ['Content-Type: image/svg+xml']],
            ['GET', 'https://fonts.gstatic.com/s/i/materialiconsoutlined/1k/v10/24px.svg', __DIR__.'/../Fixtures/1k_outlined_24px.svg', ['Content-Type: image/svg+xml']],
            ['GET', 'https://fonts.gstatic.com/s/i/materialiconsround/1k/v10/24px.svg', __DIR__.'/../Fixtures/1k_rounded_24px.svg', ['Content-Type: image/svg+xml']],
            ['GET', 'https://fonts.gstatic.com/s/i/materialiconstwotone/1k/v10/24px.svg', __DIR__.'/../Fixtures/1k_two_tone_24px.svg', ['Content-Type: image/svg+xml']],
            ['GET', 'https://fonts.gstatic.com/s/i/materialiconssharp/1k/v10/24px.svg', __DIR__.'/../Fixtures/1k_sharp_24px.svg', ['Content-Type: image/svg+xml']],
            ['GET', 'https://fonts.gstatic.com/s/i/materialicons/signal_wifi_statusbar_connected_no_internet_4/v11/24px.svg', __DIR__.'/../Fixtures/signal_wifi_statusbar_connected_no_internet_4_24px.svg', ['Content-Type: image/svg+xml']],
            ['GET', 'https://fonts.gstatic.com/s/i/materialiconsoutlined/signal_wifi_statusbar_connected_no_internet_4/v11/24px.svg', __DIR__.'/../Fixtures/signal_wifi_statusbar_connected_no_internet_4_outlined_24px.svg', ['Content-Type: image/svg+xml']],
            ['GET', 'https://fonts.gstatic.com/s/i/materialiconsround/signal_wifi_statusbar_connected_no_internet_4/v11/24px.svg', __DIR__.'/../Fixtures/signal_wifi_statusbar_connected_no_internet_4_rounded_24px.svg', ['Content-Type: image/svg+xml']],
            ['GET', 'https://fonts.gstatic.com/s/i/materialiconstwotone/signal_wifi_statusbar_connected_no_internet_4/v11/24px.svg', __DIR__.'/../Fixtures/signal_wifi_statusbar_connected_no_internet_4_two_tone_24px.svg', ['Content-Type: image/svg+xml']],
            ['GET', 'https://fonts.gstatic.com/s/i/materialiconssharp/signal_wifi_statusbar_connected_no_internet_4/v11/24px.svg', __DIR__.'/../Fixtures/signal_wifi_statusbar_connected_no_internet_4_sharp_24px.svg', ['Content-Type: image/svg+xml']],
        ];
